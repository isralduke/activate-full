...
<body>
	...
	<div class="bg-color bg-white" id="sticky-nav">
		<nav id="nav" class="wrap nav">
			<ul id="navItems" class="nav-items menu">
				<li class="menu-rocket">
					<a data-scroll href="#rocket">
			...
			<div class="col col-50">
				...
				<section class="section">
					...
					<div class="speaker-panel">
						...
						<p>envoc</p>
						<div class="speaker-socials">
							<a href="//www.facebook.com/lynseydesign" target="_blank" title="See Lynsey Jordan Gwin on Facebook">
								<?php include('partials/fb.html'); ?>
							</a>
							<a href="//twitter.com/lynseydesign" target="_blank" title="See Lynsey Jordan Gwin on Twitter">
								<?php include('partials/tw.html'); ?>
							</a>
							<a href="//www.instagram.com/lynseydesign/" target="_blank" title="See Lynsey Jordan Gwin on Instagram">
								<?php include('partials/ig.html'); ?>
							</a>
						</div>
					</div>
					...
					<div class="speaker-panel">
						...
						<p>x design</p>
						<div class="speaker-socials">
							<a href="//www.facebook.com/quinton.jason" target="_blank" title="See Quinton Jason Jr on Facebook">
								<?php include('partials/fb.html'); ?>
							</a>
							<a href="//twitter.com/quintonjasonjr" target="_blank" title="See Quinton Jason Jr on Twitter">
								<?php include('partials/tw.html'); ?>
							</a>
							<a href="//www.instagram.com/quintonjasonjr/" target="_blank" title="See Quinton Jason Jr on Instagram">
								<?php include('partials/ig.html'); ?>
							</a>
						</div>
					</div>
					...
					<div class="speaker-panel">
						...
						<p>stun design</p>
						<div class="speaker-socials">
							<a href="//www.twitter.com/isralduke" target="_blank" title="See isral Duke on Twitter">
								<?php include('partials/tw.html'); ?>
							</a>
							<a href="//www.instagram.com/isralduke" target="_blank" title="See isral Duke on Instagram">
								<?php include('partials/ig.html'); ?>
							</a>
						</div>
					</div
